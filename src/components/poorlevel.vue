        ...
        <div>
          <el-form :inline="true" :model="formInline" class="demo-form-inline">
            ...
            <el-form-item label="孤儿">
              <el-select v-model="formInline.gr" placeholder="是否孤儿">
                <el-option label="是" value="1"></el-option>
                <el-option label="否" value="0"></el-option>
              </el-select>
            </el-form-item>
            ...
            <el-form-item label="日均消费">
              <el-input v-model="formInline.consume" placeholder="日均消费"></el-input>
            </el-form-item>
          </el-form>
      ...
      <el-card class="box-card">
        ...
        <div>
          <el-table ref="filterTable" :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="consume" label="日均消费" sortable></el-table-column>
            <el-table-column
              prop="tag"
              label="标签"
              width="100"
            ...
            >
              <template slot-scope="scope">
                <el-tag
                  :type="scope.row.level === '一般困难' || scope.row.level === '非常困难' ? 'warning' : 'default'"
                  disable-transitions
